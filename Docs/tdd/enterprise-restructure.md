...
| ---------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-07-16 | Scoped-down engine defect hunt (replacing the aborted full review, see below): hand-traced `EditPlan`/`decoration-controller`/`focus-dimension`/`grouping-tree`, and probed the incremental decoration path with a scratch multi-change test. Found one PRE-EXISTING defect, not a regression: a single editor edit event carrying multiple `contentChanges` at different lines (e.g. multi-cursor edits) can drop decorations below an earlier line-shifting change, because `affectedNewLineRange`/the per-change rescan use each change's own OLD-document line number without adding the cumulative delta from other changes already applied in the same event — confirmed present verbatim in `main`'s `decoration-incremental.ts` (not introduced here). Not fixed in this migration (behavior-preservation mandate covers only the F-numbered flagged defects); recorded as a new open item in `IMPROVEMENTS.md` for a future PR. `focus-dimension.ts` and `grouping-tree.ts`'s debounce/dispose lifecycle read clean on inspection, matching their TDD claims                                                                                                                                                                                                                                                                                 | The migration's contract is "preserve behavior except the audited F-fixes" — fixing an unrelated pre-existing bug here would blur that boundary and wasn't characterization-tested first; flagging it is more valuable than a silent, untested fix, and the org API spend limit that aborted the original full engine-defect review agent made a from-scratch broad hunt impractical to retry at the same scale, so this pass traded breadth for a concrete, reproduced finding                          |
